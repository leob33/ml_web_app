...
from src.prediction import create_object_detection_model, create_video_writer_and_reader
...
def test_prediction_video_is_properly_generated():
    ...
    video_writer, video_reader = create_video_writer_and_reader(video_file_path=video_file_path,
                                                                output_directory_path=Path('test_output'),
                                                                prefix='prediction')
    model = create_object_detection_model(model_directory=Path('/Users/leo.babonnaud/lab/ml_web_app/src/ml_utils'
                                                               '/model_data'))
