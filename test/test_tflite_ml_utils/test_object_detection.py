...
from src.tflite_ml_utils.tflite_object_detection import ObjectDetectionModel
import cv2
...
def test_object_detection_model_on_video_return_list_of_dic_with_prediction_score_for_each_label():
    ...
    model = ObjectDetectionModel(labels_path=Path("test_tflite_ml_utils/data/label_map.txt"),
                                 model_path=Path("test_tflite_ml_utils/data/ssd_mobilenet_v2_5.tflite"))
