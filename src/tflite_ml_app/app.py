...
from video_prediction import make_prediction_on_video, create_object_detection_model
...
def upload():
    ...
    if request.method == 'POST':
        ...
        # run prediction
        model = create_object_detection_model(model_directory=basepath/'tflite_ml_app/model_data')
